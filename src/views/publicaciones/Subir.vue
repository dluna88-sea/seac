...
let crearPublicacion = async () => {
    ...
    let doc = document.querySelector("#uploadFile").files[0];
...
<template>
    <DefaultPage>
        <PageTitle :bread="bread">
            <Icon name="file-richtext" /> &nbsp;Subir documento
        </PageTitle>
            ...
            <div v-else class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-7 col-lg-8">        
                        ...
                        <input required type="file" class="form-control mb-3" accept="application/pdf" id="uploadFile" name="documento" aria-describedby="uploadFileAddon" aria-label="Upload">
